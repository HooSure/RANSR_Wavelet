...
# 以下强行用Python宏定义变量
halfWindowSize = 9
src1_path = r'G:\Desktop_ZXH\SpyderProg\PyWaveletAnalysistest\image_ronghe-master\dataSet\003.jpg'
src2_path = r'G:\Desktop_ZXH\SpyderProg\PyWaveletAnalysistest\image_ronghe-master\dataSet\002.jpg'
...
def runTest(src1=src1_path, src2=src2_path, isplot=True,outPut = False):
    ...
    if outPut:
        src3 = src1[:-4] + '_waveResult' + src1[-4:]
        src4 = src1[:-4] + '_pyrResult' + src1[-4:]
        cv2.imwrite(src3,waveResult)
        cv2.imwrite(src4, pyrResult)
